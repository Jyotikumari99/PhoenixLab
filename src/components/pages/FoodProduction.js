  ...
  return (
    <div>
      ...
      <div className="ailabslist card m-5 p-4">
        <p>
          At Phoenix Labs, we recognize the critical importance of food
          production and security. This section highlights our endeavors to
          harness AI to enhance agricultural practices, optimize crop yields,
          and ensure food security for a growing global population. Through
          sustainable and data-driven approaches, we are shaping a more
          resilient and abundant future for agriculture.
        </p>
      </div>
      <div className="ailabslist card m-5 p-4">
        <ul>
