  ...
  return (
    <div>
      ...
      <div className="ailabslist card m-5 p-4">
        <p>
          The Human Ownership Archives serve as a testament to our commitment to
          transparency and ethics. We maintain a record of our early projects
          that explored AI and its potential societal impact. By acknowledging
          and learning from our past, we strive to pave a more responsible and
