  ...
  return (
    <div>
      ...
      <main className="pages side">
        <img
          src="/images/pexels-tima-miroshnichenko-7567532.jpg"
          alt=""
          srcSet=""
        />
        <p>
          Our innovative platform and Machine Learning tools allow those within
          our network to upload their data to our global lexicon to provide
          annotations, judgments, and labels, creating extremely high-quality
          labeled data for others models within the network. We then provide
          leading knowledge graphs and support to ensure that data becomes
          intelligence.
        </p>
      </main>
      ...
      <section className="gpo side">
        ...
        <div className="imo">
          <p>
            The Global Digital Assets Platform (GDAP) is a blockchain-based
            network that enables processing, recording, and peer-to-peer (P2P)
            exchange of digital assets across asset classes. The network
            provides access to the Noir Coin system, which is leveraged to
            support the payment arm of Global Digital Asset Platform
            transactions.
          </p>
          <ul>
            <li>
              The Global Digital Assets Platform (GDAP) provides a suite of
              services and benefits to members of our network.
            </li>
            <li>
              Rapid Market Adaptation members in our network are able to bring
              digital use cases to life using distributed-ledger technology
              (DLT), which saves time, resources, and costs.
            </li>
            <li>
              Vetted Network- Our members comprise an established network, which
              processes the equivalent of billions of dollars in digital assets
