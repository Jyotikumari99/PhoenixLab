  ...
  return (
    <div>
      ...
      <div className="ailabslist card m-5 p-4">
        <p>
          Artificial Retrieval showcases our expertise in creating AI systems
          that augment human capabilities. From information retrieval to data
          analysis, this collection of projects embodies the idea that AI can be
          a powerful tool to amplify human intelligence and improve
