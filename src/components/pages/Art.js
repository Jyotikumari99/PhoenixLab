            ...
            <div className="contain">
                ...
                <section className="art d-flex align-items-center w-100 text-center">
                    <div className="w-100">
                        ...
                        >
                            Phoenix Labs Artificial Intelligence Center was created to further AI research and development. We believe that AI Research, tools,
                            and laboratories should be accessible to marginalized groups. It is our goal to make the tools (code, datasets, models, etc.), and
                            spaces available so that the aforementioned can easily access and use them to solve pressing problems.
                        </p>
                        <img src="../images/artbackground.jpg" alt="" height={100} width={100} />
                    </div>
                </section>
            </div>
                    ...
                    <div className="grid">
                        <div className="text-center">
                            <a href="/Data_collection">
                                <img src={data_collection} alt="here is data_collection image of the company" />
                            </a>
                            <h2 className="mt-3">Data Collection</h2>
                        </div>
                        <div className="text-center">
                            <a href="/Data_preparation">
                                <img src={data_preparation} alt="here is data_collection image of the company" />
                            </a>
                            <h2 className="mt-3">Data Preparation</h2>
                        </div>
                        <div className="text-center">
                            <a href="/ModelEvaluation">
                                <img src={model_evaluation} alt="here is model_evaluation image of the company" />
                            </a>
